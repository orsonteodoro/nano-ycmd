...
Yes (Procs Randomly/Not deterministic; tested only for %d->%s format specifier and semicolon) | Yes | Yes | FixIt | Displays trivial changes and fixes chosen ones automatically
